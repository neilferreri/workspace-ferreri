# com-chilipeppr-workspace-ferreri
A ChiliPeppr Workspace for Ferreri.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / Ferreri
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-ferreri |
| Name                  | Workspace / Ferreri |
| Description           | A ChiliPeppr Workspace for Ferreri. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/neilferreri/workspace-ferreri/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/neilferreri/workspace-ferreri |
| Github URL            | http://github.com/neilferreri/workspace-ferreri |
| Test URL              | https://preview.c9users.io/neilferreri/workspace-ferreri/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/neilferreri/workspace-ferreri/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-ferreri"], // the id you gave your workspace
      function(myWorkspaceFerreri) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / Ferreri just got loaded.", myWorkspaceFerreri);
        myWorkspaceFerreri.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-ferreri"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / Ferreri"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace for Ferreri."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/neilferreri/workspace-ferreri/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/neilferreri/workspace-ferreri"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/neilferreri/workspace-ferreri"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://workspace-ferreri-neilferreri.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
